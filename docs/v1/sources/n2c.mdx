...
This section provides advanced options for instructing Oura from which point in the chain to start reading from. Read the [intersect options](/oura/v1/advanced/intersect_options) documentation for detailed information.

### Section `source.mapper`

This section provides a way to opt-in into advances behaviour of how the raw chain data is mapped into _Oura_ events. Read the [mapper options](/oura/v1/advanced/mapper_options) documentation for detailed information.
