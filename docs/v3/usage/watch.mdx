...
```
oura watch ethereum [OPTIONS] <url>
```

- `<url>`: the Ethereum WebSocket RPC URL to connect to.
...
```sh
oura watch ethereum ws://localhost:8546
```

#### Watch Ethereum Mainnet via PublicNode

```sh
oura watch ethereum wss://ethereum-rpc.publicnode.com
```

#### Watch Ethereum With Output Throttling

```sh
oura watch ethereum ws://localhost:8546 --throttle 1000 --wrap
```

#### Watch Ethereum Sepolia Testnet
