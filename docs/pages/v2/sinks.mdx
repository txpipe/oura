...
- [File Rotate](sinks/file_rotate.md): a sink that saves events to the file system using JSONL text files.
...
- [RabbitMQ](sinks/rabbitmq.md): a sink that sends each event into a RabbitMQ exchange.
